...
------------------------------------------------------------
-- Label
simulation_name = "my_new_Hi-COLA_simulation_11_tracker_phasepair"
...
--- CDM density
cosmology_OmegaCDM = 0.24208928109433714
--- Baryon density
cosmology_Omegab = 0.04299901052133629
-- Massive neutrino density
cosmology_OmegaMNu = 0.0
-- Total dark energy density
cosmology_OmegaLambda = 0.7148310641236301
-- Effective number of relativistic species
cosmology_Neffective = 3.046
-- Temperature of CMB today
cosmology_TCMB_kelvin = 2.72548
-- Hubble parameter
cosmology_h = 0.720150390625
-- Primodial amplitude
cosmology_As = 1.46026943359375e-09
-- Spectral index
cosmology_ns = 1.05750732421875
...
if cosmology_model == "HiCOLA" then
  ...
  HiCOLA_expansion_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/Output_validation_edges/horndeski_model_run_11_expansion.txt"
end
...
if gravity_model == "HiCOLA" then
  ...
  HiCOLA_preforce_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/Output_validation_edges/horndeski_model_run_11_force.txt"
...
-- Output folder
output_folder = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Output_backend_validation_edges/COLA_11_tracker"
...
ic_input_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/P_k_z_validation_edges/Pk_lin_z49_LCDM_backscaled_11.dat"
