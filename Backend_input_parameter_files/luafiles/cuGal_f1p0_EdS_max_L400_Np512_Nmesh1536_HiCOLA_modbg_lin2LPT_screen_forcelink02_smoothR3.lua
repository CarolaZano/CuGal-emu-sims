...
------------------------------------------------------------
-- Label
simulation_name = "cuGal_f1p0_EdS_max_L400_Np512_Nmesh1536_HiCOLA_modbg_lin2LPT_screen_forcelink02_smoothR3"
...
if cosmology_model == "HiCOLA" then
  ...
  HiCOLA_expansion_filename = "/mnt/lustre/wrightw/FML/FML/COLASolver/HiCOLA_input/Galdat_f1p0_EdS_max_expansion.txt"
end
...
if gravity_model == "HiCOLA" then
  ...
  HiCOLA_input_filename = "/mnt/lustre/wrightw/FML/FML/COLASolver/HiCOLA_input/Galdat_f1p0_EdS_max_screencoupl.txt"
