...
--- CDM density
cosmology_OmegaCDM = 0.2711445851743321
--- Baryon density
cosmology_Omegab = 0.04985541482566792
-- Massive neutrino density
cosmology_OmegaMNu = 0.0
-- Total dark energy density
cosmology_OmegaLambda = 0.6789064966141874
...
if cosmology_model == "HiCOLA" then
  ...
  HiCOLA_expansion_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/Output_validation/horndeski_model_run_11_expansion.txt"
end
...
if gravity_model == "HiCOLA" then
  ...
  HiCOLA_preforce_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/Output_validation/horndeski_model_run_11_force.txt"
...
-- Output folder
output_folder = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Output_backend_validation/COLA_11_tracker"
...
ic_input_filename = "/home/c2042999/HiCOLA_env/Cubic_galileon_emu-ICGweek/Backend_input_parameter_files/P_k_z_validation/Pk_lin_z49_LCDM_backscaled_val.dat"
